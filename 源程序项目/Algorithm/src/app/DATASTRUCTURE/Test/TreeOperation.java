/*
 * @Author: 孔潇
 * @Date: 2020-07-02 15:05:51
 * @LastEditTime: 2020-07-02 16:51:12
 * @Description:  
 * @FilePath: \Data Structure\Algorithm\src\app\DATASTRUCTURE\Test\TreeOperation.java
 */
...
public class TreeOperation {
    ...
    private static void writeArray(node currNode, int rowIndex, int columnIndex, String[][] res, int treeDepth) {
        ...
        if (currNode == null)
            return;
        // 先将当前节点保存到二维数组中
        res[rowIndex][columnIndex] = getName(currNode);
